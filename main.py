...
if __name__ == "__main__":
    ...
    # now the algorithm can receive the initial calculation of the fitness_values 
    ...
    for image in target_image_path:
        ...
        for pop_size in initial_population_size:
            ...
            # if i run the with the same seed I can calculate the fitness_value for the initial population and then continue 
                initial_population = create_individuals(pop_size, triangles)
